                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <label class="form-check-label text-sm" for="gridCheck">
                                I agree with the <a class="underline text-sm text-gray-600 hover:text-gray-900" ">
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <!-- <button type="button" class="btn btn-info ml-2">Register</button> -->
                            <!-- <x-button class="btn btin-info">
                                {{ __('Register') }}
                            </x-button> -->
